...
public class SummaryViewAdapter extends RecyclerView.Adapter<SummaryViewAdapter.MyRecyclerView> {
    ...
    public SummaryViewAdapter(Context context, List<FIBSeries> list){
    ...
    public MyRecyclerView onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.summary_view,parent,false);
    ...
    public void onBindViewHolder(MyRecyclerView holder, int position) {
        ...
        holder.time.setText(series.getTimeTaken()+"");
    }
